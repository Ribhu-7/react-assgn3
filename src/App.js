  ...
  return (
    <>    
      ...
      <form  onSubmit={this.ButtonSubmit} className='form_part'>
          ...
          <input type="text" name="department" autoComplete='off' className='inpt_form'  value={this.state.department} onChange={this.ButtonChange} /><br />
          <label>Rating:</label>
          <input type="number" name="rating" autoComplete='off' className='inpt_form'  value={this.state.rating} onChange={this.ButtonChange} /><br />
